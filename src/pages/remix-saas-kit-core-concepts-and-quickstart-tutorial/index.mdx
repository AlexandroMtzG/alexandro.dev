...
export const meta = {
  title: 'Remix SaaS kit - Core Concepts and QuickStart Tutorial',
  category: 'Article',
...
Thank you for trying out my [Remix SaaS kit](https://alexandromg.gumroad.com/l/SaasFrontends-Remix)! I did not expect so many downloads, so I thought I this Quickstart Tutorial.
...
<img src={image} alt="Remix SaaS kit v1" />
