...
Before this role, we had only hired [Brad](https://alexandro.dev/welcoming-brad-cornes-to-the-tailwind-team) who we already knew and trusted, so we didn't need a job posting or any sort of rigorous application process.
