...
export const meta = {
  title: 'My designs throughout the years as a non designer',
  description: `I've been a developer for almost 9 years, I always found it a tedious work. These are my application designs since 2016.`,
...
I've been a developer for almost 9 years, I always found it a tedious work. These are my application designs since 2016.

From Winforms with dragged text boxes without proper design, to functional Vue + TailwindCSS components.

<!--more-->

## 2016 - Migration from 4GL

My dad has this legacy application written on 4GL, his forms look like this:

<img src={img1} alt="" className=" border-4 border-gray-700 rounded-md" />
