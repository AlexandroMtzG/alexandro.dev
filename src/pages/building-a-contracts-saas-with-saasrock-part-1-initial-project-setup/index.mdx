...
By the way, remember to delete the test users at /admin/users, especially the _guest@admin.com_ user that would have access to our admin portal 😅 _(or just change the password in the __prisma/seed.ts__ file before seeding)_.
