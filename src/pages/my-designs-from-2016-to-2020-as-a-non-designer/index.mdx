...
**4GL application**
<img src={img4gl} alt="4GL application" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />
...
<img src={img1} alt="Absys ERP v0.0.1" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />
...
<img src={img2} alt="My ERP application v1" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />

**v1.5** - Module-based sidebar and section details of selected module:
<img src={img3} alt="My ERP application v1.5" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />

## 2018 - Added business intelligence dashboards

**v2.0** - Role-based instead and I added a business intelligence dashboard:
<img src={img4} alt="My ERP application v1.5.0" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />
...
<img src={imgWeb} alt="Web v1.0" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />
...
<img src={img6} alt="NetcoreSaas - Landing page (marketing side)" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />

**Organization settings page** - App side:
<img src={img7} alt="NetcoreSaas - Organization settings page (app side)" className="-mt-4 border-3 border-gray-900 rounded-md w-full shadow-md" />

## Desktop vs Web

I never got comfortable enough with my desktop designs. They felt forced.

<img src={img9} alt="My Winforms app design" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />
...
<img src={img8} alt="My future SaaS app designs" className="mt-0 border-3 border-gray-900 rounded-md w-full shadow-md" />
